...
const PLACEHOLDERS = [
  { token: '{{order.number}}',                   desc: 'N° commande' },
  { token: '{{order.status}}',                   desc: 'Statut' },
  { token: '{{order.startsAt}}',                 desc: 'Début (date + heure)' },
  { token: '{{order.stopsAt}}',                  desc: 'Fin (date + heure)' },
  { token: '{{order.startsAtDate}}',             desc: 'Date de début' },
  { token: '{{order.startsAtTime}}',             desc: 'Heure de début' },
  { token: '{{order.stopsAtDate}}',              desc: 'Date de fin' },
  { token: '{{order.stopsAtTime}}',              desc: 'Heure de fin' },
  { token: '{{order.price}}',                    desc: 'Prix HT' },
  { token: '{{order.grandTotal}}',               desc: 'Total TTC' },
  { token: '{{order.grandTotalWithTax}}',        desc: 'Total avec taxes' },
  { token: '{{order.totalTax}}',                 desc: 'Montant taxes' },
  { token: '{{order.totalDiscount}}',            desc: 'Remise totale' },
  { token: '{{order.deposit}}',                  desc: 'Caution' },
  { token: '{{order.depositType}}',              desc: 'Type de caution' },
  { token: '{{order.depositValue}}',             desc: 'Valeur caution' },
  { token: '{{order.discount}}',                 desc: 'Remise' },
  { token: '{{order.discountPercentage}}',       desc: 'Remise (%)' },
  { token: '{{order.couponCode}}',               desc: 'Code coupon' },
  { token: '{{order.couponDiscount}}',           desc: 'Valeur coupon' },
  { token: '{{order.couponPercentage}}',         desc: 'Coupon (%)' },
  { token: '{{order.fulfilment_type}}',          desc: 'Type livraison' },
  { token: '{{order.delivery_carrier_name}}',    desc: 'Transporteur' },
  { token: '{{order.delivery_rate_name}}',       desc: 'Tarif livraison' },
  { token: '{{order.delivery_rate_amount}}',     desc: 'Montant livraison' },
  { token: '{{order.delivery_address}}',         desc: 'Adresse livraison' },
  { token: '{{order.billing_address}}',          desc: 'Adresse facturation' },
  { token: '{{order.barcode.image}}',            desc: 'QR code commande' },
  { token: '{{order.startLocation.name}}',       desc: 'Lieu départ — nom' },
  { token: '{{order.startLocation.address}}',    desc: 'Lieu départ — adresse complète' },
  { token: '{{order.startLocation.addressLine1}}', desc: 'Lieu départ — ligne 1' },
  { token: '{{order.startLocation.addressLine2}}', desc: 'Lieu départ — ligne 2' },
  { token: '{{order.startLocation.city}}',       desc: 'Lieu départ — ville' },
  { token: '{{order.startLocation.zipcode}}',    desc: 'Lieu départ — CP' },
  { token: '{{order.startLocation.country}}',    desc: 'Lieu départ — pays' },
  { token: '{{order.stopLocation.name}}',        desc: 'Lieu retour — nom' },
  { token: '{{order.stopLocation.address}}',     desc: 'Lieu retour — adresse complète' },
  { token: '{{order.stopLocation.addressLine1}}', desc: 'Lieu retour — ligne 1' },
  { token: '{{order.stopLocation.addressLine2}}', desc: 'Lieu retour — ligne 2' },
  { token: '{{order.stopLocation.city}}',        desc: 'Lieu retour — ville' },
  { token: '{{order.stopLocation.zipcode}}',     desc: 'Lieu retour — CP' },
  { token: '{{order.stopLocation.country}}',     desc: 'Lieu retour — pays' },
]
