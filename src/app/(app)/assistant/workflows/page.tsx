...
const TOOL_IO: Record<string, ToolIO> = {
  ...
  add_replacement_price:       { reads: ['id', 'lines', 'selected_ids', 'chosen_lines'], writes: ['replacement_lines_json', 'replacement_prices_raw'] },
...
const TOOL_DOC: Record<string, string> = {
  ...
  add_replacement_price:             'Demande le prix HT de remplacement article par article (un champ de saisie par ligne). Écrit replacement_lines_json et replacement_prices_raw utilisés par apply_replacement_prices.',
