...
const BOOQABLE_TOOLS = [
  ...
  { value: 'set_replacement_price',              label: 'set_replacement_price — saisie des prix de remplacement (champ texte, séparés par virgule)' },
...
const TOOL_DOC: Record<string, string> = {
  ...
  set_replacement_price:             'Affiche la liste des lignes sélectionnées (via choose_article ou fetch_order) et demande à l\'opérateur de saisir les prix unitaires HT séparés par des virgules. Écrit replacement_lines_json (lignes + IDs) utilisé par apply_replacement_prices.',
