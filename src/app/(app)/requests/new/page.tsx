...
// MatchDiagnosticPanel est maintenant dans @/components/MatchDiagnosticPanel
                  ...
                  {items.map((item, index) => (
                    ...
                    >
                      ...
                      {debugUid === item.uid && item.debug && (
                        <MatchDiagnosticPanel debug={item.debug} operatorProduct={item.product ?? null} allowDeleteSignal />
                      )}
                    </div>
                  ))}
                </div>
