-- ── 042_r11_code_steps.sql ───────────────────────────────────────────────────
-- R11-21 : passe add_tag, reserve_order et start_order en execution:"code"
-- pour qu'ils s'exécutent automatiquement après les étapes AI précédentes.
-- Le reste (fetch_order, add_sav_comment…) reste en AI.
-- Structure des steps identique au live — seul execution change sur 3 steps.
-- ─────────────────────────────────────────────────────────────────────────────
